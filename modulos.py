...
class Game:
    ...
    def resposta_escolha(self):
        if not self.correta == self.confirmacao:
            ...
            self.pontos = self.pontos + 100 * (self.c + 1)
    ...
    def frame1(self):
        ...
        while self.sair != True:
            ...
            self.pontuacao = self.texto_score.render(self.pontos, True, (self.cor_player))
    ...
    def frame2(self):
        ...
        while self.sair != True:
            ...
            self.pontuacao = self.texto_score.render(self.pontos, True, (20, 250, 150))
            self.vida = self.texto_score.render(self.vidas, True, (200, 200, 0))
    ...
    def frame3(self):
        ...
        while self.sair != True:
            ...
            self.texto_retry = self.texto_score.render('Tentar Novamente', True, self.cor_player)
            self.texto_menu = self.texto_score.render('Menu', True, self.cor_player)
            self.pontuacao = self.texto_score.render(self.pontos, True, (200, 30, 50))
            self.vida = self.texto_score.render(self.vidas, True, (200, 200, 0))
